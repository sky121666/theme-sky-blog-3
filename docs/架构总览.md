...
- [/templates/friends.html](/templates/friends.html)
...
- [/templates/modules/friends-app](/templates/modules/friends-app)
...
- [/src/apps/friends](/src/apps/friends)
...
| 友链朋友圈 | `friends` | `browser-friends` | `friends` | [/src/apps/friends](/src/apps/friends) |
| 链接页 | `links` | `browser-links` | `links` | [/src/apps/links](/src/apps/links) |
