import{n as p}from"../../../rolldown-runtime.js?v=0.9.34&r=ab3e4d1adbb1";var h=p({renderWidget:()=>g}),c=new Set(["auto","movie","book","music","game","drama"]),v=new Set(["auto","all","mark","doing","done"]);function i(d,a,o){const n=String(d||"").trim();return a.has(n)?n:o}function g({sources:d,escapeHtml:a,mode:o},n){if(!d.doubanAvailable)return'<div class="desktop-widget-empty">未安装豆瓣插件。</div>';const s=n?.meta||{},e=i(s.type,c,"auto"),r=i(s.status,v,"auto"),u=a(d.doubanApiBase||"/apis/api.douban.moony.la/v1alpha1/doubanmovies"),t=a(d.doubanUrl||"/douban"),b=a(n?.title||"书影音"),l=o==="preview"?"true":"false";return`
