import{n as h}from"../../../rolldown-runtime.js?v=0.9.42&r=38510dc64a9c";import{r as l}from"../../halo/author-card/render.js?v=0.9.42&r=38510dc64a9c";var M=h({renderWidget:()=>N});function f(s){const n=Number(s||0);return Number.isFinite(n)&&n>0?Math.round(n):0}function $(s={}){const n=s.spec||{},a=s.status||{},c=s.metadata||{},o=String(n.displayName||c.name||"文档项目").trim(),i=String(a.permalink||"").trim(),r=f(a.totalDocs);return{title:o,description:String(n.description||"").trim(),icon:String(n.icon||"").trim(),href:i,totalDocs:r,disabled:r<=0||!i}}function m(s,n,a=""){return n?.icon?`
