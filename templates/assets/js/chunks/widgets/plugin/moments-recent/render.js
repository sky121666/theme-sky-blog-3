import{n as h}from"../../../rolldown-runtime.js?v=0.9.42&r=c8f3c3559ee6";import{r as v}from"../../../shell-runtime/runtime/desktop/surface/edit-mode.js?v=0.9.42&r=c8f3c3559ee6";import{r as g}from"../../halo/author-card/render.js?v=0.9.42&r=c8f3c3559ee6";function l(n,s){if(!n.mediaCount)return"";const e=n.media[0],a=typeof e?.type=="string"?e.type:e?.type?.name||"",o=n.mediaCount>1?`<b>+${n.mediaCount-1}</b>`:"";return a==="PHOTO"&&e.url?`
