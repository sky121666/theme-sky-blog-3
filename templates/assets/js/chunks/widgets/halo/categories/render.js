import{o as p}from"../../../shell-runtime/runtime/desktop/surface/edit-mode.js?v=0.9.31&r=59f3cd38311b";import{r as o}from"../author-card/render.js?v=0.9.31&r=59f3cd38311b";var g='<span class="icon-[lucide--folder]" aria-hidden="true"></span>';function m({sources:n,escapeHtml:e,mode:r}){const s=p(n.categories,4);if(!s.length)return'<div class="desktop-widget-empty">当前没有可展示的分类。</div>';const c="/categories",t=s.map(a=>{const i=a.color||"currentColor",l=a.icon||g,d=i!=="currentColor"?` style="color:${e(i)}"`:"";return o({href:e(a.permalink),app:"explorer-categories",className:"wg-cat-item",disabled:r==="preview",innerHtml:`
