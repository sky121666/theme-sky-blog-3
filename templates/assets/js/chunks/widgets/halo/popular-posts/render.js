import{n as P}from"../../../rolldown-runtime.js?v=0.9.42&r=3054ad3a6ae2";import{i as $}from"../../../shell-runtime/runtime/desktop/surface/edit-mode.js?v=0.9.42&r=3054ad3a6ae2";import{r as p}from"../author-card/render.js?v=0.9.42&r=3054ad3a6ae2";import{n as v}from"../latest-posts/render.js?v=0.9.42&r=3054ad3a6ae2";var A=P({renderWidget:()=>N});function S(i,s){return i==="small"?1:i==="large"?s?4:5:3}function N({sources:i,escapeHtml:s,mode:c},b,k={}){const m=k.compact===!0,d=b?.size||"medium",y=S(d,m),o=(Array.isArray(i.popularPosts)?i.popularPosts:[]).slice(0,y);if(!o.length)return'<div class="desktop-widget-empty">热门文章暂时为空。</div>';const w=Math.max(...o.map(t=>t?.stats?.visit??0),1);let g="";if(d==="small"){const t=o[0],r=s(t?.spec?.title||"未命名文章"),n=t?.stats?.visit??0,a=$(t?.spec?.cover,i.fallbackCover),e=a?`style="background-image:url('${s(a)}')"`:"",l=a?"":" is-no-cover";g=p({href:s(t?.status?.permalink||"#"),app:"reader",className:`wg-hot-sm${l}`,attrs:e,disabled:c==="preview",innerHtml:`
