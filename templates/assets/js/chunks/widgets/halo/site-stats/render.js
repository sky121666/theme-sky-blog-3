import{n as a}from"../latest-posts/render.js?v=0.9.30&r=a79b23b81832";function m({sources:d,escapeHtml:t},e){const s=d.siteStats;if(!s)return'<div class="desktop-widget-empty">站点统计当前不可用。</div>';const v='<span class="icon-[lucide--trending-up]" aria-hidden="true"></span>',o='<span class="icon-[lucide--users]" aria-hidden="true"></span>',g='<span class="icon-[lucide--file-text]" aria-hidden="true"></span>',p='<span class="icon-[lucide--message-circle]" aria-hidden="true"></span>',w='<span class="icon-[lucide--chart-column]" aria-hidden="true"></span>';if(e.size==="medium")return`
